...
model_urls = {
    "UniConvNet_N0_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_n0_1k_224_ema.pth",
    "UniConvNet_N1_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_n1_1k_224.pth",
    "UniConvNet_N2_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_n2_1k_224_ema.pth",
    "UniConvNet_N3_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_n3_1k_224_ema.pth",
    "UniConvNet_T_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_t_1k_224_ema.pth",
    "UniConvNet_S_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_s_1k_224_ema.pth",
    "UniConvNet_B_1k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_b_1k_224_ema.pth",
    "UniConvNet_L_22k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_l_22k_224.pth",
    "UniConvNet_XL_22k": "https://huggingface.co/ai-modelwithcode/UniConvNet/resolve/main/uniconvnet_xl_22k_224.pth",
}


@register_model
def UniConvNet_N0(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[2, 2, 7, 2], dims=[48, 96, 192, 384], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_N0_1k']
...
@register_model
def UniConvNet_N1(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[2, 2, 8, 3], dims=[48, 96, 192, 384], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_N1_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_N2(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 11, 3], dims=[48, 96, 192, 384], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_N2_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_N3(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 19, 3], dims=[48, 96, 192, 384], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_N3_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_T(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 15, 3], dims=[64, 128, 256, 512], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_T_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_S(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 17, 3], dims=[80, 160, 320, 640], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_S_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_B(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[4, 4, 13, 4], dims=[112, 224, 448, 896], **kwargs)
    if pretrained:
        url = model_urls['UniConvNet_B_1k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_L(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 18, 3], dims=[160, 320, 640, 1280], **kwargs)
    if pretrained:
        assert in_22k, "only ImageNet-22K pre-trained UniConvNet-L is available; please set in_22k=True"
        url = model_urls['UniConvNet_L_22k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
...
@register_model
def UniConvNet_XL(pretrained=False, in_22k=False, **kwargs):
    model = UniConvNet(depths=[3, 3, 22, 3], dims=[160, 320, 640, 1280], **kwargs)
    if pretrained:
        assert in_22k, "only ImageNet-22K pre-trained UniConvNet-XL is available; please set in_22k=True"
        url = model_urls['UniConvNet_XL_22k']
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        model.load_state_dict(checkpoint["model"])
    return model
